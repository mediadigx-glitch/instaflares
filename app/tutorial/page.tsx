  ...
  return (
    ...
    <div className="root">
        ...
        <div className="tutorial-container">
            <div className="text-container">
                ...
                How to Get Started on Instaflares in <span>3 steps.</span>
                </h2>
            </div>
    ...
    <div className="tutorials">
      <div className="step-container">
        ...
        <h2 className="heading">Click on a <span>CTA Button</span></h2>
        <p className="description">
          Click on "Sign Up" or "Login" button to start creating your
          Instaflares account or to log in if you already have one.
        </p>
        <img src="/assets/tutorials/step-1.png" alt="" />
      </div>
      <div className="step-container">
        <span className="label">step 2</span>
        <h2 className="heading">Add Your Instagram Account</h2>
        <p className="description">
          Once logged in, you can add your Instagram account by entering your
          username in the "Instagram Username" field.
        </p>
        <img src="/assets/tutorials/step-2.png" alt="" />
      </div>
      <div className="step-container">
        <span className="label">step 3</span>
        <h2 className="heading">Verify Your Instagram Account</h2>
        <p className="description">
          After adding your Instagram username, you'll need to <span>verify that the account belongs to you.</span> Log in directly with your Instagram account for instant verification so that we can <span>verify your account ownership.</span> Once completed, your <span>account will be verified,</span> and you can access all our promotion tools. If you face any issues, our support team is available to assist you.<span> Verification ensures better security</span> and personalized promotions for your account.
        </p>
      </div>
